...
(
  ...
  unset JWT_ACCESS_SECRET JWT_REFRESH_SECRET IP_HASH_SECRET OTP_PEPPER \
    ZEPTOMAIL_TOKEN ZAVU_API_KEY GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET OPENAI_API_KEY \
...
required_settings=(
  ...
  ZEPTOMAIL_TOKEN ZEPTOMAIL_FROM_EMAIL ZAVU_API_KEY ZAVU_SENDER_ID GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET GOOGLE_REDIRECT_URI
